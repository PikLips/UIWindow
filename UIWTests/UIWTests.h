...
#import "UIWAppDelegate.h" // PikLips: the app delegate, which includes the viewController and Subview 
#import "UIWViewController.h" // PikLips: the viewController and its view 
// PikLips: code ends

@interface UIWTests : SenTestCase {
@private
    /* PikLips: code begins --
     * Creates the test instances to be tested.
     */
    UIWAppDelegate       *testAppDelegate; // PikLips: this is our test instance of the app delegate, including the window
    UIWViewController    *testViewController; //PikLips: this is the test instance of the view, created by IB
    // PikLips: code ends    
